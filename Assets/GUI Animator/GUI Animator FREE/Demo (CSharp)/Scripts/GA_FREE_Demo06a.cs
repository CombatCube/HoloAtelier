...
public class GA_FREE_Demo06a : MonoBehaviour
{
    ...
    public GUIAnimFREE m_Button5_Tertiary1;
    public GUIAnimFREE m_Button5_Tertiary2;
    public GUIAnimFREE m_Button5_Tertiary3;
    public GUIAnimFREE m_Button5_Tertiary4;
    public GUIAnimFREE m_Button5_Tertiary5;
    ...
    bool m_Button5_Tertiary1_IsOn = false;
    bool m_Button5_Tertiary2_IsOn = false;
    bool m_Button5_Tertiary3_IsOn = false;
    bool m_Button5_Tertiary4_IsOn = false;
    bool m_Button5_Tertiary5_IsOn = false;
...
//		m_PrimaryButton4.MoveIn(GUIAnimSystemFREE.eGUIMove.Self);
	...
	public void HideAllGUIs()
	{
        ...
        if (m_Button5_Tertiary1_IsOn == true)
            m_Button5_Tertiary1.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        if (m_Button5_Tertiary2_IsOn == true)
            m_Button5_Tertiary2.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        if (m_Button5_Tertiary3_IsOn == true)
            m_Button5_Tertiary3.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        if (m_Button5_Tertiary4_IsOn == true)
            m_Button5_Tertiary4.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        if (m_Button5_Tertiary5_IsOn == true)
            m_Button5_Tertiary5.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
	...
	{
		// Disable all buttons for a few seconds
		StartCoroutine(DisableAllButtonsForSeconds(0.45f));
    ...
    public void OnButton_5_tertiary1()
    {
        // Disable all buttons for a few seconds
        StartCoroutine(DisableAllButtonsForSeconds(0.45f));

        // Toggle m_Button5_Tertiary1
        ToggleButton_5_Tertiary1();

        // Toggle other tertiary buttons
        if (m_Button5_Tertiary2_IsOn == true)
        {
            ToggleButton_5_Tertiary2();
        }
        if (m_Button5_Tertiary3_IsOn == true)
        {
            ToggleButton_5_Tertiary3();
        }
        if (m_Button5_Tertiary4_IsOn == true)
        {
            ToggleButton_5_Tertiary4();
        }
        if (m_Button5_Tertiary5_IsOn == true)
        {
            ToggleButton_5_Tertiary5();
        }
    }

    public void OnButton_5_tertiary2()
    {
        // Disable all buttons for a few seconds
        StartCoroutine(DisableAllButtonsForSeconds(0.45f));

        // Toggle m_Button5_Tertiary2
        ToggleButton_5_Tertiary2();
    ...
    public void OnButton_5_tertiary3()
    {
        // Disable all buttons for a few seconds
        StartCoroutine(DisableAllButtonsForSeconds(0.45f));

        // Toggle m_Button5_Tertiary3
        ToggleButton_5_Tertiary3();
    ...
    public void OnButton_5_tertiary4()
    {
        // Disable all buttons for a few seconds
        StartCoroutine(DisableAllButtonsForSeconds(0.45f));

        // Toggle m_Button5_Tertiary4
        ToggleButton_5_Tertiary4();
    ...
    public void OnButton_5_tertiary5()
    {
        // Disable all buttons for a few seconds
        StartCoroutine(DisableAllButtonsForSeconds(0.45f));

        // Toggle m_Button5_Tertiary5
        ToggleButton_5_Tertiary5();
	...
	void ToggleButton_5()
	{
		...
		else
		{
            ...
            if (m_Button5_Tertiary1_IsOn)
                ToggleButton_5_Tertiary1();
            if (m_Button5_Tertiary2_IsOn)
                ToggleButton_5_Tertiary2();
            if (m_Button5_Tertiary3_IsOn)
                ToggleButton_5_Tertiary3();
            if (m_Button5_Tertiary4_IsOn)
                ToggleButton_5_Tertiary4();
            if (m_Button5_Tertiary5_IsOn)
                ToggleButton_5_Tertiary5();
        }
    }

    // Toggle m_Button5_Tertiary1
    void ToggleButton_5_Tertiary1()
    {
        m_Button5_Tertiary1_IsOn = !m_Button5_Tertiary1_IsOn;
        if (m_Button5_Tertiary1_IsOn == true)
        {
            // MoveIn m_Button5_Tertiary1
            m_Button5_Tertiary1.MoveIn(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
        else
        {
            // MoveOut m_Button5_Tertiary1
            m_Button5_Tertiary1.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
    }

    // Toggle m_Button5_Tertiary2
    void ToggleButton_5_Tertiary2()
    {
        m_Button5_Tertiary2_IsOn = !m_Button5_Tertiary2_IsOn;
        if (m_Button5_Tertiary2_IsOn == true)
        {
            // MoveIn m_Button5_Tertiary2
            m_Button5_Tertiary2.MoveIn(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
        else
        {
            // MoveOut m_Button5_Tertiary2
            m_Button5_Tertiary2.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
    }

    // Toggle m_Button5_Tertiary3
    void ToggleButton_5_Tertiary3()
    {
        m_Button5_Tertiary3_IsOn = !m_Button5_Tertiary3_IsOn;
        if (m_Button5_Tertiary3_IsOn == true)
        {
            // MoveIn m_Button5_Tertiary3
            m_Button5_Tertiary3.MoveIn(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
        else
        {
            // MoveOut m_Button5_Tertiary3
            m_Button5_Tertiary3.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
    }

    // Toggle m_Button5_Tertiary4
    void ToggleButton_5_Tertiary4()
    {
        m_Button5_Tertiary4_IsOn = !m_Button5_Tertiary4_IsOn;
        if (m_Button5_Tertiary4_IsOn == true)
        {
            // MoveIn m_Button5_Tertiary4
            m_Button5_Tertiary4.MoveIn(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
        else
        {
            // MoveOut m_Button5_Tertiary4
            m_Button5_Tertiary4.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
    }

    // Toggle m_Button5_Tertiary5
    void ToggleButton_5_Tertiary5()
    {
        m_Button5_Tertiary5_IsOn = !m_Button5_Tertiary5_IsOn;
        if (m_Button5_Tertiary5_IsOn == true)
        {
            // MoveIn m_Button5_Tertiary5
            m_Button5_Tertiary5.MoveIn(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
        else
        {
            // MoveOut m_Button5_Tertiary5
            m_Button5_Tertiary5.MoveOut(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
        }
    }
